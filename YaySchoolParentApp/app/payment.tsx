...
const BASE_URL = 'https://redesigned-invention-jjrv5v4g697j3pgq7-8000.app.github.dev/api/students';
...
export default function SelectStudent() {
  ...
  const handleSelectStudent = (id: number) => {
    router.push({ pathname: '/paymentSelected', params: { id } });
  };

  return (
    <>
      <Stack.Screen options={{ title: 'Billing and Payment' }} />

      <LinearGradient colors={['#FFF', '#FFE4E1']} style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>Billing and Payment</Text>
          <Text style={styles.subtitle}>
            Select a student to view billing and payment details.
          </Text>
        </View>
